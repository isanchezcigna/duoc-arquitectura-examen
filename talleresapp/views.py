...
def add_causa(request):
    response = redirect('/admin/talleresapp/causa/add/')
    return response

def add_user(request):
    response = redirect('/admin/auth/user/add/')
    return response


def admin_user(request):
    response = redirect('/admin/auth/user/')
    return response
...
def add_solicitud(request):
    response = redirect('/admin/talleresapp/solicitud/add')
    return response
